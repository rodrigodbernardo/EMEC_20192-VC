...
from main import fd_hu_moments, fd_haralick, fd_histogram
...
for file in glob.glob(test_path + "/2/*.jpg"):
    # read the image
    ...
    cv2.putText(image, train_labels[prediction], (5,5), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,255,255), 1)
